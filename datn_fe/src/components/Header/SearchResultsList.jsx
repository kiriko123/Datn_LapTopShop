...
export const SearchResultsList = ({ results, setResults, setSearchTerm   }) => {
        ...
        <div className="results-list">
            {results.map((item, id) => (
                <SearchResult
                    result={item.name}
                    key={id}
                    onClick={() => handleRedirectProduct(item)} // Handle click for redirect
                />
            ))}
        </div>
    );
