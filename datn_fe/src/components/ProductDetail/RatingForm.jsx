                            ...
                            <div key={index} className="progress-bar-wrapper">
                                ...
                                <div className="progress-bar">
                                    <div
                                        className="progress"
                                        style={{
                                            width: `${(count / ratings.length) * 100 || 0}%`,
                                    ...
                                    <div className="rating-info" style={{flexGrow: 1}}>
                                        <div className="name-user">
                                            <p>
                                                ...
                                                <span
                                                    className="rating-date">({moment(rating.createdAt).format('DD/MM/YYYY HH:mm')})</span>
                                            </p>
                                        </div>
                                        <div className="star-user">
                                            {[1, 2, 3, 4, 5].map((star) => (
                                                <span key={star}
                                                      className={`star ${rating.numberStars >= star ? 'filled' : ''}`}>
                                                ★
                                            </span>
                                            ))}
                                        </div>
                                        <div>{rating.content}</div>
                                        {/* Hiển thị nội dung đánh giá ở đây */}
                                        ...
                                        {rating.adminResponse && (
                                            <div className="admin-response" style={{
                                                ...
                                                <div style={{
                                                    ...
                                                    />
                                                    <div>
                                                        <strong>{rating.adminResponse.userName}</strong> // Thay đổi từ
                                                        "Admin" thành `{rating.adminResponse.userName}`
                                                        <span
                                                            className="response-date"> ({moment(rating.adminResponse.createdAt).format('DD/MM/YYYY HH:mm')})</span>
                                                    </div>
                                                </div>
                                        ...
                                        <div className="admin-reply">
                                            {selectedRatingId === rating.id ? (
                                                ...
                                                />
                                                    <button onClick={() => handleAdminResponseSubmit(rating.id)}>Gửi
                                                        phản hồi
                                                    </button>
                                                </>
                                            ) : (
