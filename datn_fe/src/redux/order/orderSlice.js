...
const initialState = {
    ...
    selectedVoucher: null, // Voucher đã chọn
};
...
export const orderSlice = createSlice({
    ...
    reducers: {
        ...
        doPlaceOrderAction: (state, action) => {
            state.carts = [];
            state.selectedVoucher = null; // Clear voucher when placing an order
        },
        // Thêm action mới để lưu voucher vào redux
        setVoucherAction: (state, action) => {
...
export const { doPlaceOrderAction, doAddBookAction, doUpdateCartAction, doDeleteItemCartAction,setVoucherAction } = orderSlice.actions;
